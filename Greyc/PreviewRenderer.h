...
struct PreviewRenderer
{
	...
	void UpdateProxyBuffer(auto_ptr<AlgorithmRemote::Callbacks> pCallbacks);
	...
	auto_ptr<AlgorithmRemote> m_pAlgorithm;
	...
	AlgorithmSettings LastSettings;
	AlgorithmOptions CurrentOptions;
